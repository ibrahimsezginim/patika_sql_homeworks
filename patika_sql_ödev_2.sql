...
film tablosunda bulunan replacement_cost'un 12.99 ve 16.99 arasındaki tüm sütunları gösterdikten sonra
ORDER BY ile replacement_cost'un değerlerini küçükten büyüğe doğru sıralamak için kullanabiliriz.
SELECT * FROM film
WHERE replacement_cost BETWEEN 12.99 AND 16.99
